 ...
 */
@Controller
public class ProfileSelfViewController {
    ...
    public ModelAndView ProfileFunction(HttpServletRequest req,HttpServletResponse res){
        System.out.println("ProfileFunction is called in controller");
        ...
        System.out.println("ProfileSelfViewFunction ,before logic begins");
