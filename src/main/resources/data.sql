...
-- 
-- 
-- insert into faculties(facultyID,userID,collegeID,facname) values(1,6,'cs102','te');
-- insert into faculties(facultyID,userID,collegeID,facname) values(2,7,'ec145','te2');
-- insert into faculties(facultyID,userID,collegeID,facname) values(3,8,'ee307','name3');
-- insert into faculties(facultyID,userID,collegeID,facname) values(4,9,'im092','name4');
-- 
-- -- 
...
-- 
-- insert into pollings(pollID,description,count1,option1,courseID) values(1,'des1',2,'opt1',2);
-- insert into pollings(pollID,description,count1,option1,courseID) values(2,'des2',0,'opt12',3);
-- insert into pollings(pollID,description,count1,option1,courseID) values(3,'des7',2,'opt31',1);
-- 
-- 
...
-- 
-- insert into pollcount(pollcountID,courseID,pollID,studentID,option1) values(1,1,3,1,0);
-- insert into pollcount(pollcountID,courseID,pollID,studentID,option1) values(2,1,3,4,0);